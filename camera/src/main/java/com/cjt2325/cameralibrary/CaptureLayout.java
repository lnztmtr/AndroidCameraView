...
//                resetCaptureLayout();
        ...
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            btn_return_param.setMargins(0, layout_height / 6, 0, 0);
        }
        ...
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            iv_custom_param_left.gravity = Gravity.CENTER_HORIZONTAL;
            iv_custom_param_left.setMargins(0, layout_height / 6, 0, 0);
        }
        ...
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            iv_custom_param_right.gravity = Gravity.CENTER_HORIZONTAL| Gravity.BOTTOM;
            iv_custom_param_right.setMargins(0, 0, 0, layout_height / 6);
        }
